...
__all__ = [
    'DISPID_SRCCreateResultFromMemory', 'STSF_CommonAppData',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechGrammarRuleStateTransition', 'SP_VISEME_10',
    'ISpeechGrammarRuleState', 'SITooLoud', 'SGDisplay',
    'SAFT11kHz16BitStereo', 'SITooFast', 'SRAExport',
    'DISPID_SRRAudio', 'SLODynamic', 'DISPID_SPRs_NewEnum',
    ...
    'ISpeechWaveFormatEx', 'DISPID_SVSInputSentenceLength',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRCRetainedAudioFormat', 'SPEI_RESERVED1',
    'DISPID_SVEVoiceChange',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SASNonBlockingIO', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechRecoProfileProperties', 'DISPID_SPPsCount', 'DISPID_SRGId',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SpeechRecoResult2', 'SVP_17',
    'SPCT_SUB_DICTATION', 'SVEStartInputStream',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPRuleName',
    'DISPID_SABIMinNotification', 'DISPID_SPRText',
    'eLEXTYPE_PRIVATE14', 'SpFileStream', 'SPPHRASERULE',
    'SPWT_DISPLAY', 'SAFT24kHz16BitStereo', 'SAFT8kHz16BitMono',
    'SPEI_RESERVED3', 'SAFTNonStandardFormat',
    '__MIDL_IWinTypes_0009', 'ISpeechCustomStream', 'SPPARTOFSPEECH',
    'eLEXTYPE_PRIVATE8', 'DISPID_SPPEngineConfidence',
    'SAFT22kHz8BitStereo', 'ISpProperties', 'SAFT24kHz8BitMono',
    'SAFT12kHz8BitMono', 'SPPHRASEELEMENT', 'SPADAPTATIONRELEVANCE',
    'DISPID_SPRuleId', 'SPXRO_SML', 'SPPS_Modifier',
    'DISPID_SRGDictationSetState',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRSCurrentStreamNumber', 'SpeechInterference',
    'SREPhraseStart', 'DISPID_SRGetPropertyString', 'DISPID_SBSSeek',
    'DISPID_SVDisplayUI', 'DISPID_SVGetVoices', 'SPDKL_LocalMachine',
    'DISPID_SpeechRecoResult', 'DISPID_SOTGetDescription',
    'DISPID_SASetState', 'eLEXTYPE_USER',
    'SpeechPropertyAdaptationOn', 'DISPID_SPIReplacements',
    'SREAdaptation', 'SPWF_INPUT', 'SVSFNLPSpeakPunc', 'SVP_4',
    'DISPID_SGRSTNextState', 'DISPID_SpeechBaseStream',
    'DISPID_SMSADeviceId', 'SP_VISEME_3',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechCategoryRecoProfiles', 'DISPID_SWFEBitsPerSample',
    'DISPID_SGRSTransitions', 'SVP_19', 'SPEI_VISEME',
    'DISPID_SPCPhoneToId', 'SPEI_SR_PRIVATE', 'tagSTATSTG',
    'SpeechPropertyResourceUsage', 'DISPID_SRCPause',
    'DISPID_SGRInitialState', 'SpNotifyTranslator', 'SP_VISEME_21',
    'DISPID_SRRAlternates', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SDKDeleteValue', 'IInternetSecurityManager',
    'eLEXTYPE_RESERVED9', 'SAFT16kHz16BitMono',
    'SRSInactiveWithPurge', 'DISPID_SPPParent',
    'SpeechDictationTopicSpelling', 'SAFT44kHz16BitMono',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPELexicalForm',
    'ISpeechPhraseAlternates', 'SPRECOGNIZERSTATUS',
    'DISPID_SRRGetXMLResult', 'DISPID_SPIAudioSizeTime',
    'SpeechPropertyHighConfidenceThreshold', 'ISpEventSink',
    'SITooSlow', 'SPXRO_Alternates_SML', 'DISPID_SPPName',
    'SAFT11kHz8BitStereo', 'SVSFPersistXML', 'ISpeechAudioBufferInfo',
    'SP_VISEME_8', 'eLEXTYPE_PRIVATE4', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPACommit', 'SGRSTTEpsilon', 'SpeechGrammarTagDictation',
    'ISpeechResourceLoader', 'DISPID_SWFESamplesPerSec', 'SVSFIsXML',
    'DISPID_SOTMatchesAttributes', 'DISPID_SOTCDefault', 'SINoise',
    'DISPID_SLPs_NewEnum', 'SASStop', 'SAFT22kHz16BitMono',
    'Speech_StreamPos_RealTime', 'DISPID_SpeechAudioFormat',
    'SVSFUnusedFlags', 'DISPID_SABIBufferSize', 'SVP_14',
    'ISequentialStream', 'DISPID_SRCEInterference',
    'DISPID_SpeechLexiconProns', 'DISPID_SGRSRule',
    'SAFTGSM610_8kHzMono', 'SGSExclusive',
    'DISPID_SpeechPhraseAlternate', 'SpeechGrammarTagWildcard',
    'DISPID_SRSAudioStatus', 'SpInprocRecognizer', 'DISPID_SPPId',
    'DISPID_SRRSaveToMemory', 'DISPID_SRGetFormat',
    'DISPID_SRCESoundEnd', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SpeechFileStream', 'SLTApp', 'DISPID_SVEStreamStart',
    'DISPID_SPRuleParent', 'DISPID_SRSetPropertyNumber',
    'SpeechWordPronounceable', 'DISPID_SPANumberOfElementsInResult',
    'SVSFlagsAsync', 'DISPID_SMSSetData', 'DISPID_SLWPronunciations',
    'DISPID_SWFEFormatTag', 'SpeechCategoryAudioIn',
    'SAFT11kHz16BitMono', 'SPPROPERTYINFO',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPLOADOPTIONS',
    'DISPID_SAFGetWaveFormatEx', 'SAFT32kHz8BitStereo', 'SPWORDTYPE',
    'SP_VISEME_7', 'SECFDefault', 'ISpeechFileStream',
    'DISPID_SPPConfidence', 'DISPID_SGRAddResource', 'SPSHT_OTHER',
    'DISPID_SRCEFalseRecognition', 'SVPOver', 'SRSInactive',
    'DISPID_SRRSpeakAudio', 'SpeechVoiceSkipTypeSentence',
    'SAFT16kHz8BitMono', 'SRSEIsSpeaking', 'DISPID_SRCState',
    'ISpPhoneticAlphabetConverter', 'DISPID_SVIsUISupported',
    'ISpeechLexiconPronunciations', 'SVEEndInputStream',
    'eLEXTYPE_PRIVATE13', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SPRFirstElement', 'SPBINARYGRAMMAR', 'SAFT48kHz16BitMono',
    'DISPID_SVSkip', 'DISPID_SPARecoResult',
    'DISPID_SRRSetTextFeedback', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpeechLexiconWord', 'DISPID_SpeechXMLRecoResult',
    'eLEXTYPE_PRIVATE3', 'SPWT_LEXICAL', 'DISPID_SOTRemove',
    'SPGRAMMARWORDTYPE', 'SVF_Emphasis', 'SAFT32kHz8BitMono',
    'DISPID_SVSPhonemeId', 'SPPHRASEPROPERTY', 'SPRECOCONTEXTSTATUS',
    'SVP_10', 'DISPID_SVSLastBookmark', 'DISPID_SRCRetainedAudio',
    'DISPID_SVEBookmark', 'DISPID_SpeechLexiconWords',
    'DISPID_SPRulesItem', 'ISpeechRecoGrammar',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPCLangId',
    'SpeechAudioFormatGUIDWave', 'SPEI_INTERFERENCE', 'SPAS_PAUSE',
    'SDTAudio', 'SAFTGSM610_11kHzMono', 'DISPID_SRCEAdaptation',
    'SPEI_RESERVED2', 'SpObjectTokenCategory', 'DISPID_SPIRule',
    'DISPID_SpeechObjectTokens', 'ISpeechMMSysAudio', 'SVP_15',
    '_ISpeechVoiceEvents', 'SPFM_NUM_MODES', '_SPAUDIOSTATE',
    'DISPID_SRRTLength', 'SpeechAudioVolume', 'SECFNoSpecialChars',
    'DISPID_SASFreeBufferSpace', 'DISPID_SPRulesCount',
    'SREPropertyStringChange', 'SRTEmulated', 'ISpNotifySource',
    'DISPID_SRGState', 'DISPID_SRCEStartStream',
    'DISPID_SPEs_NewEnum', 'SVEPhoneme', 'DISPID_SPAPhraseInfo',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRSTType',
    'DISPID_SWFEExtraData', 'DISPID_SGRSAddSpecialTransition',
    'SAFTNoAssignedFormat', 'DISPID_SLPPartOfSpeech',
    'eLEXTYPE_MORPHOLOGY', 'SpeechCategoryRecognizers',
    'SDKLDefaultLocation', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SAEventHandle', 'DISPID_SLRemovePronunciation',
    'DISPID_SpeechPhraseAlternates', 'SPSInterjection', 'SPAR_Low',
    'SpeechCategoryVoices', 'SPAO_RETAIN_AUDIO', 'eLEXTYPE_RESERVED7',
    'DISPID_SPEDisplayText', 'SDTLexicalForm',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SpeechVoiceEvent',
    'SPRECORESULTTIMES', 'DISPID_SOTCSetId', 'DISPID_SMSGetData',
    'ISpRecoResult', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRCreateRecoContext', 'SPEI_MAX_TTS', 'DISPID_SRGReset',
    'ISpeechGrammarRuleStateTransitions', 'ISpeechPhraseElements',
    'SPPS_NotOverriden', 'SPBO_TIME_UNITS',
    'DISPID_SLGetPronunciations', 'SPEI_REQUEST_UI', 'ISpAudio',
    'DISPID_SVSpeak', 'SAFTADPCM_44kHzStereo',
    'DISPID_SpeechRecognizerStatus', 'SP_VISEME_12',
    'DISPID_SPPFirstElement', 'SAFT12kHz16BitStereo',
    'DISPID_SRRDiscardResultInfo', 'SVSFNLPMask',
    'DISPID_SRGetRecognizers', 'DISPID_SOTGetAttribute',
    'SPRST_INACTIVE', 'DISPID_SLPType', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVSLastBookmarkId', 'DISPID_SVSVisemeId',
    'SPEI_RECOGNITION', 'ISpShortcut', 'SPEI_VOICE_CHANGE',
    'DISPID_SABufferNotifySize', 'SPDATAKEYLOCATION',
    'DISPID_SRGCmdLoadFromObject', 'SGLexicalNoSpecialChars',
    'SVSFIsFilename', 'DISPID_SPEAudioTimeOffset',
    'ISpeechXMLRecoResult', 'ISpObjectWithToken', 'SSFMOpenReadWrite',
    'SpeechVoicePriority', 'ISpRecoGrammar2',
    'DISPID_SVSyncronousSpeakTimeout', 'SPWF_SRENGINE',
    'ISpStreamFormatConverter', 'SPEI_PHRASE_START', 'SpCustomStream',
    'SPEI_HYPOTHESIS', 'DISPID_SPIGrammarId',
    'DISPID_SpeechRecoContextEvents', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SVP_6', 'SAFTGSM610_22kHzMono', 'ISpeechLexicon',
    'SPSEMANTICFORMAT', 'SDTPronunciation', 'SPEVENTSOURCEINFO',
    'DISPID_SRCEAudioLevel', 'SDKLLocalMachine',
    'SpeechTokenKeyFiles', 'STCAll', 'SP_VISEME_17', 'SRARoot',
    'DISPID_SPEsCount', 'SWPUnknownWordPronounceable',
    'DISPID_SBSFormat', 'ISpeechPhraseReplacement', 'IEnumString',
    'DISPID_SVGetAudioOutputs', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SGRsCount', 'SRAORetainAudio', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SGRsFindRule', 'SPEI_PROPERTY_NUM_CHANGE',
    'ISpResourceManager', 'Speech_Default_Weight',
    'DISPID_SRCEEndStream', 'SPFM_CREATE_ALWAYS',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRState',
    'DISPID_SLWsItem', 'SBOPause', 'DISPID_SPRuleEngineConfidence',
    'SVP_1', 'DISPID_SVESentenceBoundary', 'SVP_20',
    'DISPID_SRRecognizer', 'SRTReSent', 'SpWaveFormatEx',
    'SRTStandard', 'SRAInterpreter', 'STSF_LocalAppData', 'SVP_13',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SpeechVoice', 'SPSUnknown',
    'SPTEXTSELECTIONINFO', 'DISPID_SRRAudioFormat',
    'DISPID_SpeechLexicon', 'ISpeechPhraseInfo', 'ISpeechAudioFormat',
    'SpeechVisemeFeature', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SVEventInterests', 'SVSFParseSapi', 'SAFT12kHz8BitStereo',
    'SGPronounciation', 'SASPause', 'SpResourceManager',
    'SAFT11kHz8BitMono', 'SVSFParseSsml', 'DISPID_SVEEnginePrivate',
    'SpPhraseInfoBuilder', 'SAFT32kHz16BitStereo',
    'DISPID_SpeechPhoneConverter', 'SWPKnownWordPronounceable',
    'eLEXTYPE_PRIVATE17', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SLGetWords', 'ISpPhraseAlt', 'ISpeechPhoneConverter',
    'SVEVoiceChange', 'DISPID_SVVolume', '_ISpeechRecoContextEvents',
    'ISpRecognizer2', 'SpeechTokenKeyUI', 'SFTSREngine',
    'SpeechTokenIdUserLexicon', 'SVSFIsNotXML', 'SVP_12',
    'SPGS_DISABLED', 'DISPID_SRSCurrentStreamPosition', 'SGRSTTRule',
    'SPVPRI_ALERT', 'DISPID_SDKCreateKey',
    'SDA_Consume_Leading_Spaces', 'SpeechLoadOption',
    'DISPID_SpeechLexiconPronunciation', 'SPRULE',
    'DISPID_SRCEPropertyStringChange', 'SpeechEngineProperties',
    'DISPID_SLWs_NewEnum', 'SpeechRecoContextState',
    'DISPID_SOTGetStorageFileName', 'SpeechTokenContext',
    'DISPID_SPIEngineId', 'DISPID_SRGRules', 'DISPID_SLPPhoneIds',
    'SPEI_SR_BOOKMARK', 'SPEI_START_INPUT_STREAM',
    'SREPropertyNumChange', 'SpMMAudioIn', 'eLEXTYPE_PRIVATE12',
    'DISPID_SWFEChannels', 'ISpeechRecoResultDispatch',
    'SDKLCurrentUser', 'SRSActive', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SDKEnumValues', 'DISPIDSPRG', 'tagSPPROPERTYINFO',
    'SPCT_COMMAND', 'SECFEmulateResult', 'DISPID_SRCVoicePurgeEvent',
    'SpeechRuleAttributes', 'DISPID_SpeechPhraseElements',
    'SPEI_TTS_BOOKMARK', 'SDTProperty', 'DISPID_SDKSetLongValue',
    'SPEI_SOUND_START', 'ISpSerializeState', 'ISpRecoCategory',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRGetPropertyNumber',
    'DISPID_SVSLastStreamNumberQueued', 'SpAudioFormat', 'ISpLexicon',
    'DISPID_SRGCmdLoadFromFile', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechObjectToken', 'SpeechRegistryUserRoot',
    'eLEXTYPE_PRIVATE9', 'SPAS_RUN', 'eLEXTYPE_PRIVATE15',
    'IInternetSecurityMgrSite', 'eLEXTYPE_RESERVED4',
    'SPSHORTCUTPAIR', 'DISPID_SPRsCount', 'SAFTADPCM_8kHzStereo',
    'SSTTDictation', 'SPSHT_Unknown', 'ISpeechAudio',
    'DISPID_SVEWord', 'SPGRAMMARSTATE', 'eLEXTYPE_PRIVATE20',
    'SDA_Two_Trailing_Spaces', 'DISPID_SLWsCount',
    'DISPID_SVSRunningState', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SDKSetStringValue', 'SGLexical', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRGSetWordSequenceData', 'ISpeechDataKey', 'DISPID_SOTId',
    'DISPID_SRCRequestedUIType', 'DISPID_SOTCGetDataKey',
    'SpeechDiscardType', 'DISPID_SPRNumberOfElements', 'SPAS_STOP',
    'DISPID_SpeechAudioStatus', 'SpMMAudioEnum', 'DISPID_SGRsCommit',
    'SPWT_PRONUNCIATION', 'SAFTCCITT_ALaw_8kHzStereo', 'SPEI_PHONEME',
    'SPCS_ENABLED', 'SPRS_ACTIVE', 'SREPrivate', 'DISPID_SVRate',
    'DISPID_SGRSTRule', 'DISPID_SPIElements', 'SAFT8kHz16BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'STCInprocHandler',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVPriority',
    'SPPS_SuppressWord', 'SpUnCompressedLexicon',
    'ISpeechPhraseRules', 'UINT_PTR', 'SREStateChange',
    'DISPID_SABIEventBias', 'ISpXMLRecoResult', 'SVEAllEvents',
    'ISpeechGrammarRule', 'SFTInput', 'DISPID_SPIStartTime',
    'DISPID_SREmulateRecognition', 'ISpeechRecognizerStatus',
    'SVP_18', 'SREHypothesis', 'SPPS_Function', 'SAFT48kHz8BitMono',
    'SPFM_CREATE', 'SP_VISEME_1',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_PRIVATE1',
    'SECNormalConfidence', 'DISPID_SOTCreateInstance', 'SPSHT_EMAIL',
    'SRADefaultToActive', 'DISPID_SpeechGrammarRuleState',
    'SDTDisplayText', 'SVP_3', 'SpeechMicTraining', 'SPEI_MIN_TTS',
    'SPXMLRESULTOPTIONS', 'eLEXTYPE_LETTERTOSOUND', 'DISPID_SAFGuid',
    'DISPID_SRCEPropertyNumberChange', 'SpeechRecoEvents',
    'SPWAVEFORMATTYPE', 'DISPID_SGRAttributes', 'SPBO_NONE',
    'DISPID_SVGetAudioInputs', 'SRCS_Enabled', 'SPDKL_CurrentUser',
    'SpMemoryStream', 'eLEXTYPE_APP', 'DISPID_SVSpeakStream',
    ...
    'SSTTTextBuffer', 'SPSHORTCUTPAIRLIST', 'SREAllEvents',
    'SpeechAddRemoveWord', 'DISPID_SRCERecognizerStateChange',
    'eLEXTYPE_RESERVED8', 'ISpeechVoice',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechMemoryStream',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SECLowConfidence',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SMSAMMHandle',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRGCommit',
    'DISPID_SpeechPhraseRule', 'ISpeechObjectToken',
    'SVEWordBoundary', 'SPPHRASE', 'SPPHRASEREPLACEMENT',
    'SRESoundStart', 'DISPID_SpeechRecoResultTimes',
    'SVSFParseAutodetect', 'SpeechRetainedAudioOptions', 'SVP_21',
    'DISPID_SRRTOffsetFromStart', 'SpPhoneticAlphabetConverter',
    'SECHighConfidence', 'SPVPRIORITY', 'SRERequestUI',
    'eWORDTYPE_DELETED', 'ISpRecoGrammar', 'DISPID_SVSLastResult',
    'SDTAll', 'SpShortcut', 'SPEI_END_INPUT_STREAM', 'DISPID_SAFType',
    'SPINTERFERENCE_TOOSLOW', 'SAFT32kHz16BitMono',
    'DISPID_SRIsUISupported', 'SITooQuiet',
    'DISPID_SRGCmdSetRuleIdState', 'SVESentenceBoundary',
    'DISPID_SRStatus', 'SPEI_TTS_PRIVATE', 'ISpPhrase',
    'SpeechGrammarState', 'SpInProcRecoContext', 'DISPID_SBSRead',
    'SVPAlert', 'ISpeechPhraseAlternate', 'STSF_FlagCreate',
    'SRTAutopause', 'SPCT_SUB_COMMAND', 'SpeechTokenKeyAttributes',
    'SP_VISEME_20', 'SPPS_Verb', 'DISPID_SpeechObjectTokenCategory',
    'SpeechRuleState', 'SPAUDIOBUFFERINFO', 'SpeechVisemeType',
    'SAFT44kHz8BitMono', 'DISPID_SOTCId', 'DISPID_SOTsItem',
    'SDA_No_Trailing_Space', 'SAFTCCITT_uLaw_44kHzStereo',
    'SREInterference', 'DISPID_SRCCmdMaxAlternates', 'SECFIgnoreCase',
    'eLEXTYPE_PRIVATE19', 'SAFTCCITT_ALaw_22kHzMono',
    'SPWORDPRONUNCIATIONLIST', 'eLEXTYPE_RESERVED6',
    'DISPID_SAStatus', 'SAFT8kHz8BitStereo',
    'DISPID_SRAudioInputStream', 'DISPID_SPERequiredConfidence',
    'SASRun', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPERetainedSizeBytes', 'eLEXTYPE_PRIVATE5',
    'DISPID_SpeechPhraseReplacements', 'SPSModifier',
    'SpeechAllElements', 'DISPID_SPRules_NewEnum',
    'DISPID_SGRSTPropertyId', 'IEnumSpObjectTokens',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SGRSTsItem',
    'SAFTADPCM_8kHzMono', 'SGDSActive', 'DISPID_SPRuleConfidence',
    'SRTExtendableParse', 'DISPID_SPPValue', 'SREBookmark',
    'SRADynamic', 'SDA_One_Trailing_Space', 'SPEI_UNDEFINED',
    'DISPID_SPEPronunciation', 'ISpNotifySink', 'SPFM_OPEN_READWRITE',
    'ISpStream', 'SDTReplacement', 'SRCS_Disabled', 'SSFMCreate',
    'SP_VISEME_11', 'SPEI_RESERVED5', 'DISPID_SRGSetTextSelection',
    'SPSFunction', 'DISPID_SAVolume', 'DISPID_SRCEventInterests',
    'DISPIDSPTSI_ActiveLength', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpRecoContext2', 'DISPID_SDKDeleteKey', 'ISpeechRecoResult',
    'SPEI_START_SR_STREAM', 'DISPID_SDKOpenKey',
    'SpeechGrammarWordType', 'SSFMCreateForWrite',
    'ISpeechRecognizer', 'SPCONTEXTSTATE', 'SRAONone', 'SWTDeleted',
    'DISPID_SLWLangId', 'SRATopLevel', 'SpeechVoiceEvents',
    'SpeechCategoryAudioOut', 'SpeechCategoryPhoneConverters',
    'DISPID_SPISaveToMemory', 'ISpDataKey', 'ISpVoice',
    'DISPID_SVVoice', 'SpSharedRecoContext', 'SVP_11',
    'SpeechAudioFormatGUIDText', 'SPSLMA', 'SP_VISEME_6',
    'DISPID_SRCResume', 'SPINTERFERENCE', 'ISpeechAudioStatus',
    'SINoSignal', 'SREFalseRecognition',
    'DISPID_SPEDisplayAttributes', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SVEAudioLevel', 'SpSharedRecognizer',
    'SpStreamFormatConverter', 'DISPID_SGRsItem', 'SPRULESTATE',
    'SGSEnabled', 'SpeechEmulationCompareFlags',
    'DISPID_SpeechDataKey', 'SPBO_PAUSE', 'SP_VISEME_13',
    'SVEBookmark', 'SSSPTRelativeToEnd', 'SWTAdded',
    'DISPID_SRRTStreamTime', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPRST_NUM_STATES', 'DISPID_SRGDictationLoad',
    'ISpeechPhraseElement', 'SPCT_SLEEP', 'DISPID_SRAudioInput',
    'SPSVerb', 'SINone', 'DISPID_SVSInputWordPosition',
    'eLEXTYPE_PRIVATE16', 'SPSNoun', 'SpeechTokenShellFolder',
    'DISPID_SOTCategory', 'SAFTADPCM_22kHzMono', 'SPVISEMES',
    'SpeechWordType', 'SPPS_RESERVED1', 'SPBO_AHEAD',
    'SpeechBookmarkOptions', 'SPSSuppressWord',
    'SpeechVoiceCategoryTTSRate', 'SpeechDisplayAttributes',
    'ISpNotifyTranslator', 'DISPID_SLAddPronunciation',
    'DISPID_SpeechPhraseProperties', 'SpLexicon', 'SPPS_RESERVED4',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechAudioBufferInfo', 'SAFTADPCM_11kHzMono',
    'ISpObjectTokenCategory', 'DISPID_SRCERequestUI',
    'DISPID_SRGDictationUnload', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVResume', 'SPRST_ACTIVE', 'SPAUDIOOPTIONS',
    'DISPID_SVAudioOutputStream', 'DISPID_SDKGetStringValue',
    'ISpEventSource', 'SECFIgnoreKanaType', 'DISPID_SRDisplayUI',
    'STSF_AppData', 'DISPID_SGRName', 'DISPID_SRSClsidEngine',
    'DISPID_SPAsItem', 'SGSDisabled', 'SWPUnknownWordUnpronounceable',
    'SPAR_Medium', 'SpNullPhoneConverter',
    'DISPID_SPIAudioStreamPosition', 'eLEXTYPE_RESERVED10',
    'eLEXTYPE_PRIVATE18', 'SpeechLexiconType', 'SPSEMANTICERRORINFO',
    'SpeechRecognitionType', 'SAFT24kHz16BitMono', 'SPWORDLIST',
    'SpVoice', 'DISPID_SRProfile', 'SSTTWildcard',
    'DISPID_SPEAudioSizeBytes', 'SPEI_SENTENCE_BOUNDARY',
    'ISpeechRecoResultTimes', 'DISPID_SPEAudioStreamOffset',
    'SPINTERFERENCE_NOISE', 'SPAUDIOSTATUS', 'SPEI_ADAPTATION',
    'DISPID_SRSSupportedLanguages', 'SRTSMLTimeout',
    'DISPID_SPPNumberOfElements', 'DISPID_SRSetPropertyString',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRGIsPronounceable',
    'DISPID_SMSALineId', 'DISPID_SPPs_NewEnum',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPPsItem',
    'SpeechFormatType', 'DISPID_SLWType', 'DISPID_SLPsCount',
    'SPEI_MIN_SR', 'DISPID_SRCVoice', 'DISPID_SGRSTPropertyName',
    'SRAImport', 'DISPID_SPEsItem', 'SPWORDPRONUNCIATION',
    'DISPID_SWFEBlockAlign', 'SVP_2', 'SAFT8kHz8BitMono',
    'eLEXTYPE_PRIVATE11', 'DISPID_SDKSetBinaryValue', 'SVP_16',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SGRs_NewEnum',
    'DISPID_SRCBookmark', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVSInputWordLength', 'DISPID_SOTsCount', 'LONG_PTR',
    'WAVEFORMATEX', 'STCInprocServer', 'SPGS_EXCLUSIVE', 'SPAR_High',
    'SpeechDataKeyLocation', 'SVEAudioLevel', 'DISPID_SRRRecoContext',
    'SSFMOpenForRead', 'DISPID_SRRTTickCount', 'DISPID_SCSBaseStream',
    'SAFTADPCM_44kHzMono', 'ISpeechPhraseReplacements',
    'DISPID_SGRSTText', 'SGDSInactive', 'DISPID_SpeechPhraseInfo',
    'DISPID_SVEViseme', 'SAFTDefault', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SOTDataKey', 'DISPID_SGRId', 'SAFTCCITT_uLaw_22kHzStereo',
    'SP_VISEME_0', 'ISpRecognizer3', 'SPPS_LMA', 'SpeechPartOfSpeech',
    'DISPIDSPTSI_SelectionOffset', 'SSSPTRelativeToStart',
    'DISPID_SLPLangId', 'DISPID_SRCSetAdaptationData',
    'DISPID_SVWaitUntilDone', '_RemotableHandle', 'DISPID_SRIsShared',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SDTRule', 'SPLO_STATIC',
    'DISPID_SLWWord', 'SPGS_ENABLED',
    'DISPID_SPAStartElementInResult', 'DISPID_SPILanguageId',
    'DISPID_SGRSAddRuleTransition', 'SPSMF_UPS', 'SPPS_RESERVED2',
    'SpeechRunState', 'ISpeechPhraseRule', 'SAFT44kHz8BitStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SVStatus',
    'SPSERIALIZEDRESULT', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SGRSTTWildcard', 'DISPID_SDKEnumKeys', 'DISPID_SGRSTsCount',
    'SECFIgnoreWidth', 'eWORDTYPE_ADDED', 'SVSFParseMask',
    'DISPID_SASState', 'ISpeechPhraseProperty',
    'DISPID_SPEActualConfidence', 'DISPID_SPRsItem',
    'DISPID_SGRsDynamic', 'ISpeechRecoResult2', 'DISPID_SVPause',
    'SPCS_DISABLED', 'ISpGrammarBuilder', 'ISpeechObjectTokens',
    'SPWORDPRONOUNCEABLE', 'ISpeechVoiceStatus',
    'DISPID_SOTDisplayUI', 'DISPID_SVGetProfiles',
    'SAFT16kHz8BitStereo', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechPhraseProperty', 'SPFILEMODE',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRCEHypothesis', 'SVP_0',
    'DISPID_SABufferInfo', 'DISPID_SpeechGrammarRule',
    ...
    'ISpRecoContext', 'DISPID_SRCRecognizer', 'SPSERIALIZEDPHRASE',
    'ISpMMSysAudio', 'SAFT48kHz16BitStereo',
    'SpeechGrammarRuleStateTransitionType', 'SDTAlternates',
    'DISPID_SRCAudioInInterferenceStatus', 'SPLEXICONTYPE',
    'SRSActiveAlways', 'SPPS_RESERVED3', 'eLEXTYPE_PRIVATE10',
    'DISPID_SOTs_NewEnum', 'SPSMF_SRGS_SAPIPROPERTIES',
    'STCRemoteServer', 'SP_VISEME_16', 'DISPID_SpeechPhraseElement',
    'SpeechAudioFormatType', 'DISPID_SVSInputSentencePosition',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SPCIdToPhone',
    'ISpeechObjectTokenCategory', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SpeechRecognizer', 'SREStreamStart',
    'DISPID_SRCEEnginePrivate', 'DISPID_SRCEPhraseStart',
    'SPAUDIOSTATE', 'ISpeechLexiconWords', 'SP_VISEME_14', 'SPWORD',
    'SpMMAudioOut', 'SREStreamEnd', 'SPFM_OPEN_READONLY',
    'DISPID_SPEEngineConfidence',
    'DISPID_SRCERecognitionForOtherContext',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechRecognizerState',
    'SPRECOSTATE', 'SPBOOKMARKOPTIONS', 'SpeechTokenValueCLSID',
    'SLTUser', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SFSOpen', 'SAFTGSM610_44kHzMono', 'eLEXTYPE_PRIVATE7',
    'SAFTCCITT_uLaw_8kHzStereo', 'SBONone',
    'DISPID_SRGCmdSetRuleState', 'SpeechCategoryAppLexicons',
    'SP_VISEME_9', 'SVP_5', 'SPVPRI_NORMAL', 'SAFT12kHz16BitMono',
    'SASClosed', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SGRClear',
    'DISPID_SpeechMemoryStream', 'DISPID_SpeechPhraseBuilder',
    'SPEI_WORD_BOUNDARY', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPPBRestorePhraseFromMemory', 'Speech_Max_Pron_Length',
    'SpeechStreamFileMode', 'DISPID_SVEStreamEnd',
    'SAFTExtendedAudioFormat', 'SAFT48kHz8BitStereo',
    'DISPID_SPAsCount', 'SpStream', 'DISPID_SVEPhoneme',
    'DISPID_SPRuleNumberOfElements', 'Speech_StreamPos_Asap',
    'DISPID_SRRPhraseInfo', 'SVEPrivate',
    'SpeechSpecialTransitionType', 'DISPID_SPAs_NewEnum',
    'SPVOICESTATUS', 'DISPID_SGRsAdd',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_MAX_SR', 'SRESoundEnd',
    'SPPS_Noun', 'ISpObjectToken', 'SpeechVoiceSpeakFlags',
    'DISPID_SPPChildren', 'DISPID_SGRSTs_NewEnum', 'SPEVENTENUM',
    'SVF_None', 'DISPID_SOTSetId', 'DISPID_SGRSTWeight', 'SPEVENT',
    'DISPID_SpeechPhraseRules', 'SPDKL_DefaultLocation',
    'DISPID_SPEAudioSizeTime', 'DISPID_SAFSetWaveFormatEx', 'SVP_8',
    'SVEViseme', 'SGRSTTDictation', 'SP_VISEME_4', 'SP_VISEME_5',
    'DISPID_SADefaultFormat', 'SVF_Stressed', 'SVP_7',
    'SPDKL_CurrentConfig', 'SVP_9', 'DISPID_SpeechRecoContext',
    'SPSHORTCUTTYPE', 'SAFT44kHz16BitStereo',
    'ISpeechLexiconPronunciation', 'SAFT24kHz8BitStereo',
    'SVSFDefault', 'SPSTREAMFORMATTYPE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPSHT_NotOverriden',
    'SRERecoOtherContext', 'SPINTERFERENCE_NONE',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRCERecognition',
    'DISPID_SRRTimes', 'SLOStatic', 'Speech_Max_Word_Length',
    'DISPID_SRRGetXMLErrorInfo', 'SP_VISEME_18', 'SPLO_DYNAMIC',
    'SPCT_DICTATION', 'SpeechAudioProperties', 'SAFT22kHz16BitStereo',
    'ISpPhoneticAlphabetSelection', 'SpeechPropertyResponseSpeed',
    'SP_VISEME_2', 'DISPID_SDKGetlongValue', 'DISPID_SpeechAudio',
    'SAFT22kHz8BitMono', 'SpTextSelectionInformation',
    'SRERecognition', 'SPCATEGORYTYPE', 'ISpStreamFormat',
    'ISpRecognizer', 'SPINTERFERENCE_NOSIGNAL', 'SpeechAudioState',
    'ISpeechTextSelectionInformation', 'STCLocalServer', 'IStream',
    'SPEI_SOUND_END', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SGRSTPropertyValue', 'SPAO_NONE', 'DISPID_SFSClose',
    'DISPID_SBSWrite', 'SPPS_Interjection', 'DISPID_SRCESoundStart',
    'SREAudioLevel', 'ISpeechBaseStream', 'DISPID_SpeechLexiconWord',
    'SPPS_Unknown', 'DISPID_SLPSymbolic', 'SAFTText',
    'DISPID_SOTIsUISupported', 'DISPID_SRCCreateGrammar',
    'DISPID_SPIGetText', 'SGRSTTWord', 'DISPID_SGRSAddWordTransition',
    'DISPID_SGRAddState', 'DISPID_SLGenerationId',
    'tagSPTEXTSELECTIONINFO', 'SAFT16kHz16BitStereo',
    'DISPID_SPIAudioSizeBytes', 'SPEI_RESERVED6', 'DISPID_SLPsItem',
    'DISPID_SPRuleFirstElement', 'DISPID_SPIProperties',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SP_VISEME_19',
    'SVPNormal', 'SpCompressedLexicon', 'SAFTCCITT_ALaw_8kHzMono',
    'SpObjectToken', 'DISPIDSPTSI', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SVAudioOutput', 'SRSEDone', 'SDKLCurrentConfig',
    'SPAR_Unknown', 'SPRS_INACTIVE', 'SGRSTTTextBuffer',
    'SPSNotOverriden', 'SPVPRI_OVER', 'DISPID_SASCurrentSeekPosition',
    'SVSFVoiceMask', 'SPEI_END_SR_STREAM', 'SGDSActiveWithAutoPause',
    'SpPhoneConverter'
]
